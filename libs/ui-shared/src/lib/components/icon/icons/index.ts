...
export { ReactComponent as collapseOpen } from "./collapse-open.svg";
export { ReactComponent as collapseClosed } from "./collapse-closed.svg";
...
export { ReactComponent as trashSmall } from "./trash-small.svg";
