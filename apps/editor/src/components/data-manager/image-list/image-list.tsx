...
export const ImageList = ({
  ...
  const deleteImage = useCallback(
    (image: MiaImage) => onImageDelete && onImageDelete([image]),
    [onImageDelete],
  );
  ...
  const startReviewWithSelected = useCallback(
    () => onStartReview && selectedImages && onStartReview(selectedImages),
    [onStartReview, selectedImages],
  );
  ...
  const selectImage = useCallback(
    (image: MiaImage, index: number, selected: boolean) => {
